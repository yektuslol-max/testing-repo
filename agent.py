...
class Agent:
    ...
    def run(self, question: str) -> str:
        ...
        """
        # Record the end-to-end trace input for the Confident AI Observatory.
...
User question: {question}""",
        ...
        # Capture clean input/output on the agent span and the trace (avoids the
        # noisy `self` argument that would otherwise be auto-captured).
